...
import { Text, View, Image, Modal, FlatList, TouchableOpacity, ScrollView, SafeAreaView } from "react-native";
...
const ProfileScreen = (props: any) => {
    ...
    const selectedAvatar = useSelector((state: any) => state.reducer.selectedAvatar);
